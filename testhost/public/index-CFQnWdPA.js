...
const { toString: Ze } = Object.prototype, { getPrototypeOf: ue } = Object, K = /* @__PURE__ */ ((e) => (t) => {
  const n = Ze.call(t);
...
const tt = v("string"), x = v("function"), Pe = v("number"), X = (e) => e !== null && typeof e == "object", nt = (e) => e === !0 || e === !1, z = (e) => {
  if (K(e) !== "object")
    return !1;
  const t = ue(e);
...
}, ut = C("URLSearchParams"), [lt, ft, dt, pt] = ["ReadableStream", "Request", "Response", "Headers"].map(C), ht = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
), pe = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), xt = C("RegExp"), Le = (e, t) => {
...
}, _t = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, Y = "abcdefghijklmnopqrstuvwxyz", he = "0123456789", Be = {
  DIGIT: he,
  ALPHA: Y,
...
const Bt = (e) => {
  ...
  return n(e, 0);
}, Dt = C("AsyncFunction"), Ut = (e) => e && (X(e) || x(e)) && x(e.then) && x(e.catch), De = ((e, t) => e ? setImmediate : t ? ((n, r) => (L.addEventListener("message", ({ source: s, data: o }) => {
  ...
  x(L.postMessage)
), kt = typeof queueMicrotask < "u" ? queueMicrotask.bind(L) : typeof process < "u" && process.nextTick || De, a = {
  isArray: U,
  isArrayBuffer: Ne,
  isBuffer: Ye,
  isFormData: ct,
...
function G(e, t, n) {
  ...
  function l(p, y, h) {
    ...
    return se(p) ? !0 : (t.append(me(h, y, o), u(p)), !1);
  }
...
}, Mt = typeof URLSearchParams < "u" ? URLSearchParams : le, zt = typeof FormData < "u" ? FormData : null, $t = typeof Blob < "u" ? Blob : null, Jt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Mt,
    FormData: zt,
...
const Ve = (e) => {
  ...
  t.headers = i = A.from(i), t.url = He(Je(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
...
}, Q = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", We = Q && typeof ReadableStream == "function", En = Q && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Ke = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
...
const Sn = async (e) => {
  ...
  let h;
  try {
    if (f && Rn && n !== "get" && n !== "head" && (h = await gn(l, r)) !== 0) {
      let T = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
    ...
    let S = await fetch(p);
    const g = ie && (u === "stream" || u === "response");
    if (ie && (c || g && y)) {
      const T = {};
      ["status", "statusText", "headers"].forEach((de) => {
        T[de] = S[de];
      });
      const _ = a.toFiniteNumber(S.headers.get("content-length")), [F, M] = c && Ee(
        _,
        V(Re(c), !0)
      ) || [];
      S = new Response(
